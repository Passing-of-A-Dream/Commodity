  ...
  <div class="container" :class="{ 'sign-up-mode': signUpMode }">
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <!-- 登录 -->
        <loginForm :loginFood="loginFood" :rules="rules" />
        <!-- 奶茶 -->
        <!-- <el-form
          :model="registerMilkTea"
          label-width="100px"
          class="registerForm sign-up-form"
        >
          <el-form-item label="邮箱" prop="address">
            <span>{{ registerMilkTea.address }}</span>
            <el-input
              v-model="registerMilkTea.address"
              placeholder="请输入账号..."
            ></el-input>
          </el-form-item>
          <el-form-item label="密码" prop="password">
            <span>{{ registerMilkTea.password }}</span>
            <el-input
              v-model="registerMilkTea.password"
              type="password"
              placeholder="请输入密码..."
            ></el-input>
          </el-form-item>
...
import { loginFood, rules } from "@/utils/loginValidators";
